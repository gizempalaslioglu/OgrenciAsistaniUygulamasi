...
public class MessageActivity extends AppCompatActivity {
    ...
    private void setUpChatRoom(){  //mesajların altında chat room ismi(unique)
    ...
    private void attachMessageListener(String chatRoomId){ //mesajlar değiştiği zaman activitymizi bilgilendirip yeni mesajları çekeceğiz
